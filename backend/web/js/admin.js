...
var tinymceConfig = {
    selector:'.redactor',
    plugins: [
        'link image imagetools table autoresize collections gallery code paste media lists fullscreen stickytoolbar'
    ],
    contextmenu: "link image imagetools table spellchecker",
    toolbar: "code fullscreen | undo redo | styleselect | bold italic | alignleft aligncenter alignright alignjustify | bullist numlist blockquote | link image | collections gallery | media",
    language: 'ru',
    extended_valid_elements : "collection[data-id],gallery[data-id|data-limit|data-type]",
