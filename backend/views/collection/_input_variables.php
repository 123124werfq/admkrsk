...
<div class="form-group">
    ...
    switch ($data->type) {
        ...
        case CollectionColumn::TYPE_FILE:
            ...
            break;
            echo Html::textInput("CollectionColumn[columns][$key][variables][]",$data->variables,['class'=>'form-control','id'=>'CollectionColumn2_variables'.$key, 'placeholder'=>'Максимальное количество файлов']);
            break;
