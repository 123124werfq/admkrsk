<?php
    ...
    $pages = ArrayHelper::map(Page::find()->all(), 'id_page', 'title');
?>
...
<div id="list-records" class="multiinput sortable m-t">
    ...
    <div class="row" data-row="<?=$key?>">
        ...
        <div class="col-md-3">
            <?=Html::dropDownList("MenuLink[links][$key][id_page]",$data->id_page,$pages,['class'=>'form-control','id'=>'CollectionColumn_type'.$key,'prompt'=>'Выберите раздел']);?>
        </div>
        <div class="col-md-1">
