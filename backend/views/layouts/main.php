...
<div id="wrapper">
    ...
    <div id="page-wrapper" class="gray-bg">
        ...
        <?=''//Alert::widget(['options' => ['class' => 'row']])?>
                    ...
                    <div id="tab-1" class="tab-pane active">
                        ...
                        <div>
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="<?= $bundle->baseUrl . '/inspinia/img/a1.jpg' ?>">
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="<?= $bundle->baseUrl . '/inspinia/img/a2.jpg' ?>">
                                    </div>
                                    <div class="media-body">
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="<?= $bundle->baseUrl . '/inspinia/img/a3.jpg' ?>">
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="<?= $bundle->baseUrl . '/inspinia/img/a4.jpg' ?>">
                                    </div>
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="<?= $bundle->baseUrl . '/inspinia/img/a8.jpg' ?>">
                                    </div>
                                    <div class="media-body">
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="<?= $bundle->baseUrl . '/inspinia/img/a7.jpg' ?>">
                                    </div>
                                    <div class="media-body">
