...
use backend\controllers\FormInputTypeController;
...
$this->registerJsFile('/js/gridSettings.js', ['depends' => [yii\web\JqueryAsset::className()]]);
$this->registerJsFile('/js/datePicker/moment.min.js', ['depends' => [yii\web\JqueryAsset::className()]]);
$this->registerJsFile('/js/datePicker/jquery.daterangepicker.min.js', ['depends' => [yii\web\JqueryAsset::className()]]);

$this->registerCssFile('/css/datePicker/daterangepicker.min.css');
$this->registerCssFile('/css/grid.css');
...
<div class="form-input-type-index">
    ...
    <?= GridView::widget([
        ...
        'tableOptions' => [
            ...
            'data-grid' => FormInputTypeController::grid,
            'id' => 'grid',
        ]
    ]); ?>
