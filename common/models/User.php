...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    static public function openId()
    {
        $config = new Config([
            'clientId' => '236403241',
            'privateKeyPath' => Yii::getAlias('@app') . '/assets/cert2023-new.pem', // '/assets/admkrsk-new.pem',
            'certPath' => Yii::getAlias('@app') . '/assets/cert2023-new.pem', // '/assets/admkrsk-new.pem',
